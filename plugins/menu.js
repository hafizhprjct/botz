...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://telegra.ph/file/73bf3a2bd31f5e6b7ca89.jpg'
    conn.sendButton(m.chat,
`𝚂𝚒𝚖𝚙𝚕𝚎 𝙱𝚘𝚝 𝚆𝚑𝚊𝚝𝚜𝙰𝚙𝚙 | 𝙱𝚢 ×ʏᴢᴀɴ ʀᴇᴀʟʟ 

${wish()} ${name}
`, text.trim(), `https://telegra.ph/file/73bf3a2bd31f5e6b7ca89.jpg`, [
