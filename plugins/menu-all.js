...
const defaultMenu = {
'document':{'https://telegra.ph/file/b02e49bb28aa6669e5489.jpg'},
  before: `╭─────═[ INFO USER ]═─────⋆
│╭───────────────···
┴│☂︎ *Name:* %name
⬡│☂︎ *Limit:* %limit
...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://telegra.ph/file/8233c803b7963c160484d.jpg'
    conn.sendButton(m.chat,
`𝚂𝚒𝚖𝚙𝚕𝚎 𝙱𝚘𝚝 𝚆𝚑𝚊𝚝𝚜𝙰𝚙𝚙 | 𝙱𝚢 xyzan Reall 

${wish()} ${name}
`, text.trim(), `https://telegra.ph/file/8233c803b7963c160484d.jpg`, [
      [`Sewa Bot`, `${usedPrefix}sewa`],
      [`۪۪Up Premium`, `${usedPrefix}uppremium`]
