...
{title: `💌 ${emot} OWNER BOT`, rowId: ".own", description: "Menampilkan List owner BOT"},
{title: `📔 ${emot} SCRIPT BOT`, rowId: ".sc", description: `Source Code ${namebot}`},
]
},{
title: `${htki} SUPPORT ${htka}`,
rows: [
{title: `🔖 ${emot} SEWA`, rowId: ".sewabot", description: "Menampilkan list harga sewa BOT"},
{title: `🌟 ${emot} BUY PREMIUM`, rowId: ".uppremium", description: "Menampilkan list harga premium"},
{title: `🤖 ${emot} JASA RUN`, rowId: ".jadibot2", description: 'Menampilkan list harga jadi bot'},
]
},{
...
let imgrr = `https://telegra.ph/file/b02e49bb28aa6669e5489.jpg`
...
┗┳━━◩
┍┛
┆➯ My Owner : https://wa.me/628812258855
└─┈⟅
┍━─┈❏➢ 
┆𝙽𝚊𝚖𝚎 : ${name}
┆Tᴀɢ : ${tag}
